...
public class ExpressionTest {
    ...
    public void testMakePlus() {
        Expression exp = Expression.makePlus(Expression.make(10, 4), Expression.make("foo"));
    ...
    public void testMakeMultiply() {
        Expression exp = Expression.makeMultiply(Expression.make(10, 4), Expression.make("foo"));
    ...
    public void testEqualsPlus() {
        ...
        Expression op2 = Expression.make(5, 0);
        Expression p = Expression.makePlus(op1, op2);

        assertEquals("expected equal strings", "(x + 5)", p.toString());
        assertNotEquals("expected different strings", "(5 + x)", p.toString());
    }
    ...
    public void testEqualsMultiply() {
        ...
        assertEquals("expected equal strings", "(x * 5)", m.toString());
        assertNotEquals("expected different strings", "(5 * x)", m.toString());
    }
